...
namespace WindowsFormsApp7
{
    public partial class SearchSpecializationForm : Form
    {
        ...
        private void SearchSpecializationForm_Load(object sender, EventArgs e)
        {
        ...
        private void SearchSpecializationForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            myConnection.Close();
            e.Cancel = true;
            Hide();
        ...
        {
            специальностьBindingSource.Filter = "[Код студента]=\'" + Convert.ToInt32(textBoxKod.Text) + "\'";
        }
    }
}
