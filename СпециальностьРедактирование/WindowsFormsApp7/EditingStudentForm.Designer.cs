...
namespace WindowsFormsApp7
{
    partial class EditingStudentForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.фамилияСтудентаDataGridViewTextBoxColumn.MinimumWidth = 8;
            this.фамилияСтудентаDataGridViewTextBoxColumn.Name = "фамилияСтудентаDataGridViewTextBoxColumn";
            this.фамилияСтудентаDataGridViewTextBoxColumn.Width = 150;
            // 
            ...
            this.имяСтудентаDataGridViewTextBoxColumn.MinimumWidth = 8;
            this.имяСтудентаDataGridViewTextBoxColumn.Name = "имяСтудентаDataGridViewTextBoxColumn";
            this.имяСтудентаDataGridViewTextBoxColumn.Width = 150;
            // 
            ...
            this.отчествоСтудентаDataGridViewTextBoxColumn.MinimumWidth = 8;
            this.отчествоСтудентаDataGridViewTextBoxColumn.Name = "отчествоСтудентаDataGridViewTextBoxColumn";
            this.отчествоСтудентаDataGridViewTextBoxColumn.Width = 150;
            // 
